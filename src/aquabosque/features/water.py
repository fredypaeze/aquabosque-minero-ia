...
_CLASIFICACION_POR_PARAMETRO: dict[str, str] = {
    ...
    # Fase 4B.2: parámetros normalizados por `normalize_water_parameter_name`,
    # que separa isómeros que la normalización genérica (Fase 3B) fusionaba.
    "ALFA HEXACLOROCICLOHEXANO ALFA HCH EN AGUA": "hidrocarburo_organico",
    "BETA HEXACLOROCICLOHEXANO BETA HCH EN AGUA": "hidrocarburo_organico",
    "GAMMA HEXACLOROCICLOHEXANO GAMMA HCH EN AGUA": "hidrocarburo_organico",
    "DELTA HEXACLOROCICLOHEXANO DELTA HCH EN AGUA": "hidrocarburo_organico",
    "ALFA ENDOSULFAN EN AGUA": "hidrocarburo_organico",
    "BETA ENDOSULFAN EN AGUA": "hidrocarburo_organico",
