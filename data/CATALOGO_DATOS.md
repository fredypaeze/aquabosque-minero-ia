...
| UPZ Bogotá (en vivo) | **IDECA / Sec. de Gobierno** — waserver Mapa_Base capa UPZ | Datos Abiertos Bogotá | 2026-08-10 | 116 UPZ (115 útiles) | polígono UPZ (con localidad) | 1,4 MB geojson | centroide → localidad (point-in-polygon); redondeo de geometría a 4 decimales; join a susceptibilidad; gradiente oriente–occidente (proxy etiquetado). Script `08_bogota_upz.py` → `data/processed/bogota_upz.{csv,geojson}` |
